    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <Button variant="outline" size="sm" onClick={() => addArrItem("colors", { colorName: "", colorValue: "" })}>
            Add Color
          </Button>
        </div>
        ...
        <div>
          ...
          <Button variant="outline" size="sm" onClick={() => addArrItem("sizes", { size: "", amountOfSiize: 0 })}>
            Add Size
          </Button>
        </div>
      </div>
