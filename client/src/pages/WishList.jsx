    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-rose-50 to-red-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">{wishItems.length} items in your Wish List</p>
        </div>

        {wishItems.length === 0 ? (
          <div className="text-center py-16">
            <Heart className="w-16 h-16 text-gray-400 mx-auto mb-4" />
            <h2 className="text-2xl font-semibold text-gray-600 mb-4">Your Wish List is empty</h2>
            <p className="text-gray-500 mb-8">Save your favorite lingeries to buy later!</p>
            <Link to="/products">
