...
const [viewMode, setViewMode] = useState("grid")
  ...
  useEffect(() => {
    const productCategory = async () => {
      const res = await fetchProductCategory("Sleep wears")
        if(!res) {
        setProducts([])
      }
      setProducts(res)
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4 bg-gradient-to-r from-pink-600 to-red-800 bg-clip-text text-transparent">
            Sleep Wears Collection
          </h1>
          <p className="text-gray-600 max-w-2xl">Drift into luxury with our dreamy sleepwear collection—crafted for ultimate comfort, soft touches, and effortless elegance. From cozy nights in to slow, stylish mornings.</p>
        </div>
