...
const [viewMode, setViewMode] = useState("grid")
  ...
  useEffect(() => {
    const productCategory = async () => {
      const res = await fetchProductCategory("Lounge wears")
        if(!res) {
        setProducts([])
      }
      setProducts(res)
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-rose-50 to-red-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 max-w-2xl">Slip into ultimate relaxation with our stylish loungewear collection—designed for effortless comfort, soft textures, and laid-back elegance. Perfect for staying in or stepping out in style.</p>
        </div>
