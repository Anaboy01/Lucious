 ...
 const [viewMode, setViewMode] = useState("grid")
  ...
  useEffect(() => {
    const productCategory = async () => {
      const res = await fetchProductCategory("Lingeries")
        if(!res) {
        setProducts([])
      }
      setProducts(res)
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-rose-50 to-red-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 max-w-2xl">Unveil your sensual side with our irresistible lingerie collection—where comfort meets seduction. From effortlessly chic to boldly intimate, find the perfect pieces to ignite every moment.</p>
        </div>
